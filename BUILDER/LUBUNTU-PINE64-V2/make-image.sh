...
TARBALL="${DIST_NAME}-lubuntu-pine64-rootfs-${RELEASE}.tar.bz2"
IMAGE="${DIST_NAME}-lubuntu-pine64-${RELEASE}.img"
...
function make_pine64_image() {
    ...
    # SIZE_LIMIT -> (707 + 73) ~ 780 MB | SIZE -> 780 * 1024 * 1024 / 512 = 1597440     |  SEEK = SIZE_LIMIT * 1.1 = 820 (it should be 825. then it won't boot.)
    SIZE_LIMIT=780
    SIZE=1597440
    SEEK=820
