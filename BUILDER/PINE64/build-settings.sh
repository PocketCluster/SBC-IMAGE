...
TARBALL="${FLAVOUR}-${VERSION}${QUALITY}-server-arm64-rootfs.tar.bz2"
IMAGE="${FLAVOUR}-${VERSION}${QUALITY}-server-arm64-pine64.img"
BASEDIR=${PWD}/C2Flavor/${RELEASE}
BUILDDIR=${BASEDIR}/${FLAVOUR}
BASE_R=${BASEDIR}/base
DEVICE_R=${BUILDDIR}/pine64
ARCH=$(uname -m)
export TZ=UTC
